...
(function () {
  ...
  var PC_NAV_CONFIG = {
    people: [
      ...
      { label: 'Handbook signatures',            href: '/handbook-signatures/',    slug: 'handbook-signatures' }, { label: 'Text consent', href: '/sms-consent/', slug: 'sms-consent' }, { label: 'Text messages', href: '/sms-console/', slug: 'sms-console' },
